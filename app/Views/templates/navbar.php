...
<head>
    ...
    <style>
        ...
        .hero__text {
            background-color: rgba(0, 0, 0, 0.5);
            color: white;
            /* Tambahkan warna teks yang sesuai */
        }
    </style>
</head>
            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="header__logo">
                        <a href="<?= base_url(); ?>">
                            <img src="<?= base_url('assets/img/logo-karastore.png') ?>" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li class="active"><a href="<?= base_url("CheckTransactions") ?>">Check Transaction</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
